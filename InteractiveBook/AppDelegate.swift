...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Initialize Parse.
        Parse.setApplicationId("yFWZ7xVIDWLMOKuunBBU9vTaTR5TQbWVj9E8QAXS",
            clientKey: "4grkhZKUiM7c1atyghd8aef5v7aWX5830twitObG")
        ...
        NSTimer.scheduledTimerWithTimeInterval(5.0, target: self, selector: "moveToMain", userInfo: nil, repeats: false)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "info.yiqin.InteractiveBook" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("InteractiveBook", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("InteractiveBook.sqlite")
